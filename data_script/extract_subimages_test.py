...
def main():
    ...
    if mode == 'pair':
        ...
        GT_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/DIV2K_valid_HR'  # fix to your path
        LR_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/DIV2K_valid_LR_bicubic/X4'  # fix to your path
        save_GT_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/TMP/DIV2K_valid_HR_sub/GT'
        save_LR_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/TMP/DIV2K_valid_HR_sub/LR'
