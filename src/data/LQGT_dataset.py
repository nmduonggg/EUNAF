...
class LQGT_dataset(data.Dataset):
    ...
    def __init__(self, opt, root_dir, phase='train'):
        ...
        self.paths_GT, self.sizes_GT = util.get_image_paths(self.data_type, os.path.join(root_dir, 'GT'))
        self.paths_LQ, self.sizes_LQ = util.get_image_paths(self.data_type, os.path.join(root_dir, 'LR'))
        self.phase=phase
    ...
    def __getitem__(self, index):
        ...
        if self.phase == 'test':
            ...
            img_LQ, img_GT = util.augment([img_LQ, img_GT], True, True)
