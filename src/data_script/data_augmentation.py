...
import sys
sys.path.append("..")
import data_script.utils as util
...
for scale in [1, 0.9, 0.8, 0.7, 0.6]:
    GT_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/DIV2K_train_HR'
    
    save_GT_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/TMP/DIV2K_train_HR_scale/GT'
