...
from data_script.utils import ProgressBar  # noqa: E402
import data_script.utils as data_util  # noqa: E402
...
def main():
    ...
    if mode == 'pair':
        # cut training data
        GT_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/TMP/DIV2K_train_HR_scale/HR/x4'  # fix to your path
        LR_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/TMP/DIV2K_train_HR_scale/LR/x4'  # fix to your path
        save_GT_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/TMP/DIV2K_scale_sub/GT'
        save_LR_folder = '/mnt/disk1/nmduong/FusionNet/data/DIV2K/TMP/DIV2K_scale_sub/LR'
